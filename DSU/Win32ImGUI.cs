...
partial class Win32ImGui
{
    ...
    private static partial class NativeMethods
    {
        ...
        public static partial IntPtr LoadCursorA(IntPtr hInstance, string lpCursorName);
    ...
    public static class BitwiseHelpers
    {
        ...
        public static int HIWORD(long dwValue) => (int)((dwValue >> 16) & 0xFFFF);
        public static int HIWORD(UIntPtr dwValue) => (int)((dwValue.ToUInt64() >> 16) & 0xFFFF);
        public static int LOWORD(int dwValue) => dwValue & 0xFFFF;
        public static int LOWORD(long dwValue) => (int)(dwValue & 0xFFFF);
        public static int LOWORD(UIntPtr dwValue) => (int)(dwValue.ToUInt64() & 0xFFFF);
        public static byte HIBYTE(short wordValue) => (byte)((wordValue >> 8) & 0xFF);
        public static byte HIBYTE(ushort wordValue) => (byte)((wordValue >> 8) & 0xFF);
        public static byte LOBYTE(short wordValue) => (byte)(wordValue & 0xFF);
        public static byte LOBYTE(ushort wordValue) => (byte)(wordValue & 0xFF);
        public static bool HIGHBIT(int dwValue) => (dwValue & 0x80000000) != 0;
        public static int GetWheelDeltaWPARAM(UIntPtr wParam) => (short)((((int)wParam.ToUInt32()) >> 16) & 0xFFFF);
        public static int GET_Y_LPARAM(nint lp) => (short)((lp.ToInt32() >> 16) & 0xFFFF);
        public static int GET_Y_LPARAM(long lp) => (short)((lp >> 16) & 0xFFFF);
        public static int GET_Y_LPARAM(UIntPtr lp) => (short)((lp.ToUInt32() >> 16) & 0xFFFF);
        public static int GET_X_LPARAM(nint lp) => (short)(lp.ToInt32() & 0xFFFF);
        public static int GET_X_LPARAM(long lp) => (short)(lp & 0xFFFF);
        public static int GET_X_LPARAM(UIntPtr lp) => (short)(lp.ToUInt32() & 0xFFFF);
    }
    ...
    private static StringBuilder sb = new(4);
    ...
    public unsafe static ImGui_ImplWin32_Data* ImGui_ImplWin32_GetBackendData()
    {
        ...
        return (ImGui_ImplWin32_Data*)ImGui.GetIO().BackendPlatformUserData;
    }

    public static unsafe void ImGui_ImplWin32_UpdateKeyboardCodePage(ImGuiIOPtr io)
    {
        ImGui_ImplWin32_Data* backendDataPtr = (ImGui_ImplWin32_Data*)io.BackendPlatformUserData;
    ...
    public static unsafe bool ImGui_ImplWin32_Init(IntPtr hwnd, bool platform_has_own_dc = false)
    {
        ...
        System.Diagnostics.Debug.Assert(io.BackendPlatformUserData == IntPtr.Zero, "Already initialized a platform backend!");
        ...
        try
        {
            ...
            io.BackendPlatformUserData = bdPtr;
        ...
        finally
        {
            ...
            {
                Marshal.FreeHGlobal(bdPtr);
                io.BackendPlatformUserData = IntPtr.Zero;
                var mainViewport = ImGui.GetMainViewport();
                mainViewport.PlatformHandle = mainViewport.PlatformHandleRaw = IntPtr.Zero;
            }
        }
    }
    ...
    public unsafe static ImGuiKey ImGui_ImplWin32_KeyEventToImGuiKey(UIntPtr wParam, IntPtr lParam)
    {
        ...
        if (wp == VK.VK_RETURN && (BitwiseHelpers.HIWORD(lParam.ToInt64()) & 0x0100) != 0) return ImGuiKey.KeypadEnter;
    ...
    public static IntPtr ImGui_ImplWin32_WndProcHandler(IntPtr hwnd, uint msg, UIntPtr wParam, IntPtr lParam)
    {
        if (ImGui.GetCurrentContext() == IntPtr.Zero)
            return 0;
        return ImGui_ImplWin32_WndProcHandlerEx(hwnd, msg, wParam, lParam, ImGui.GetIO());
    }
    public unsafe static IntPtr ImGui_ImplWin32_WndProcHandlerEx(IntPtr hwnd, uint _msg, UIntPtr wParam, IntPtr lParam, ImGuiIOPtr io)
    {
        WM msg = (WM)_msg;
        if (io.BackendPlatformUserData == IntPtr.Zero)
            return 0;
        ...
        switch (msg)
        {
            ...
            case WM.WM_MOUSEWHEEL:
                io.AddMouseWheelEvent(0.0f, (float)BitwiseHelpers.GetWheelDeltaWPARAM(wParam) / (float)120);
                return 0;
            case WM.WM_MOUSEHWHEEL:
                io.AddMouseWheelEvent(-(float)BitwiseHelpers.GetWheelDeltaWPARAM(wParam) / (float)120, 0.0f);
                return 0;
            case WM.WM_KEYDOWN:
            case WM.WM_KEYUP:
            ...
            case WM.WM_SYSKEYUP:
                {
                    ...
                    if (wParam < 256)
                    {
                        ...
                        int scancode = BitwiseHelpers.LOBYTE((short)BitwiseHelpers.HIWORD(lParam.ToInt64()));
